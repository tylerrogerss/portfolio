...
```{r}
# loading the data
seattle_weather <- read_csv("/cloud/project/finalproject/seattle-weather.csv") 
```
...
```{r}
save(weather_folds, weather_recipe, weather_train, weather_test, file = "/cloud/project/finalproject/rda.rda")
```
...
```{r}
save(weather_en_tune_res, file = "/cloud/project/finalproject/en.rda")

save(weather_knn_tune_res, file = "/cloud/project/finalproject/knn.rda")

save(weather_rf_tune_res, file = "/cloud/project/finalproject/rf.rda")
...
```{r}
load("/cloud/project/finalproject/en.rda")

load("/cloud/project/finalproject/knn.rda")

load("/cloud/project/finalproject/rf.rda")
```
